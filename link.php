...
isset ($_GET['OrderDone']) || isset ($_GET['OrderError']) || isset ($_GET['OrderErrors']) ||
...
public static function ToOrderErrors()
{
return self::Build('order-errors/');
}
public static function ToCheckoutInfo()
{
return self::Build('checkout-info/');
}
